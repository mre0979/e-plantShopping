...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      {/* <p className="plant_logo_left"><img src="img/greenleaf.jpg" height='50px' width='50px' alt="" /></p> */}
      <p className="about-us-content">
      ...
      {/* <p className="plant_logo_right"><img src="img/greenleaf.jpg" height='50px' width='50px' alt="" /></p> */}
